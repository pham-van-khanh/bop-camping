...
| PDF (in lịch giao) | **barryvdh/laravel-dompdf** | Thuần PHP — prod VPS không cần Chromium/binary. Font nhúng DejaVu Sans cho tiếng Việt; Blade PDF riêng dùng `<table>` + inline style, KHÔNG dùng Tailwind. Xem `artifacts/adr_pdf_generation.md`. |
