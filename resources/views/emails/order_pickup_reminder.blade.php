    ...
    <div style="margin:14px 0 4px;border-top:1px solid #efe7d5;padding-top:14px;">
        <table role="presentation" cellpadding="0" cellspacing="0" style="width:100%;border-collapse:collapse;font-size:14px;">
            ...
            <tr>
                ...
                <td style="padding:8px 0 0;text-align:right;font-family:{{ $mono }};font-weight:800;font-size:15px;color:#2e2a20;white-space:nowrap;border-top:1px solid #efe7d5;">{{ number_format($order->transfer_due, 0, ',', '.') }}đ (COD)</td>
            </tr>
            @else
            <tr>
