...
const DEFAULT_SLIDES: Slide[] = [
    ...
    { src: '/images/album/cloud-sea-sunrise.jpg', title: 'Biển mây đón bình minh' },
    { src: '/images/album/beach-sunset-relax.jpg', title: 'Hoàng hôn trên bãi biển' },
...
export default function HeroSlideshow({ children, aside, slides }: { children?: ReactNode; aside?: ReactNode; slides?: Slide[] }) {
    ...
    return (
        <section
            ...
            style={{ minHeight: 'clamp(560px,90vh,780px)', background: '#0f1a08' }}
        >
            {/* Track ảnh */}
            <div className="absolute inset-0 overflow-hidden">
                <div
                    ...
                    style={{
                        ...
                        transition: reduced.current ? 'none' : 'transform .8s cubic-bezier(.22,.7,.2,1)',
                    }}
                >
                    {SLIDES.map((s, i) => (
                        <div key={s.src} className="relative h-full w-full flex-none" aria-hidden={i !== index}>
                            <div
                                className={i === index ? 'kenburns h-full w-full' : 'h-full w-full'}
            ...
            <div
                ...
                style={{ background: 'linear-gradient(90deg,rgba(8,14,5,.82) 0%,rgba(8,14,5,.52) 40%,rgba(8,14,5,.12) 72%,rgba(8,14,5,.3) 100%)' }}
            />
            <div
                className="absolute inset-0"
                style={{ background: 'linear-gradient(180deg,rgba(8,14,5,.3) 0%,rgba(8,14,5,0) 26%,rgba(8,14,5,0) 58%,rgba(8,14,5,.6) 100%)' }}
            />
                ...
                <div className="mx-auto flex max-w-[1400px] items-end justify-between gap-4 px-5 pr-[80px] sm:pr-[128px]">
                            ...
                            return (
                                <button
                                    ...
                                    style={{
                                        ...
                                        outline: active ? '2px solid #bfe06a' : '1px solid rgba(255,255,255,.4)',
                    ...
                    <div className="flex flex-none gap-2">
                        <button
                            ...
                            style={{ border: '1px solid rgba(255,255,255,.45)', background: 'rgba(8,14,5,.4)', backdropFilter: 'blur(6px)' }}
                        >
                            ‹
                        </button>
                        <button
