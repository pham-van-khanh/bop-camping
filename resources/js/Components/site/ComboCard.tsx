import {
    LocationBadges,
    type CardLocation,
} from '@/Components/site/LocationBadge';
...
export type ComboCardData = {
    ...
    // Cơ sở bán combo (bopcamping-daet) — combo có kho RIÊNG, không suy ra từ món con.
    // all_locations = bán ở đủ mọi cơ sở đang mở -> gộp badge "Toàn hệ thống".
    ...
    return (
        ...
        >
            <Link
                ...
                aria-label={
                    soldOut
                        ? `${c.name} — hết hàng trong khoảng ngày đã chọn`
                        : undefined
                }
            ...
            >
                ...
                >
                    ...
                    <div
                        ...
                        style={{
                            background:
                                'radial-gradient(120px 90px at 78% 22%, rgba(255,255,255,.3), transparent 60%)',
                        }}
                    />
                ...
                <div className="flex flex-1 flex-col px-4 pb-4 pt-3.5">
                    <div className="min-h-[39px] text-[15.5px] font-bold leading-[2.25] text-ink">
                        {c.name}
                    </div>
                    {c.suitable_for && (
                        <span
                            className="mt-1.5 self-start rounded-pill px-2.5 py-1 text-[11.5px] font-semibold"
                            style={{ background: '#e7eed5', color: '#3a5a1f' }}
                        >
                    ...
                    <div className="mt-auto flex flex-wrap items-end justify-between gap-x-2 gap-y-1 pt-2.5">
                        <div>
                            ...
                            {c.savings_amount > 0 && (
                                <div className="font-mono text-[12px] text-[#ff4747] line-through">
