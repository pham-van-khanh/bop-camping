...
export default function FaqSection({ faqs }: { faqs: FaqItem[] }) {
    ...
    return (
        <section id="faq" className="mx-auto max-w-[820px] scroll-mt-24 px-5 pb-5 pt-[54px]">
            <motion.div
            ...
            >
                <div className="mb-2 font-mono text-[12px] tracking-[0.1em] text-campfire">GIẢI ĐÁP THẮC MẮC</div>
                <h2 className="font-extrabold tracking-tight text-ink" style={{ fontSize: 'clamp(24px,3vw,32px)' }}>
                    Câu hỏi thường gặp
                </h2>
            </motion.div>
                        ...
                        >
                            ...
                            >
                                ...
                                <span
                                    ...
                                    style={{ background: isOpen ? '#557A2B' : '#eef2e3', color: isOpen ? '#fff' : '#557A2B', transform: isOpen ? 'rotate(45deg)' : 'none' }}
                                >
                            ...
                            >
                                <p className="whitespace-pre-line px-5 pb-4 text-[14.5px] leading-[1.65] text-[#3f4a32]">{faq.answer}</p>
                            </motion.div>
                        </motion.div>
                    );
                })}
