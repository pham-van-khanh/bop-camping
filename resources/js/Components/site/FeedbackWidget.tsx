...
export default function FeedbackWidget() {
    ...
    const err = (msg?: string) =>
        msg && <p className="mt-1 text-[12px] text-[#b3493a]">{msg}</p>;
                    ...
                    >
                        {sent ? (
                            <div className="py-4 text-center">
                                ...
                                <h2 className="mb-1.5 text-[18px] font-extrabold text-ink">
                                    Cảm ơn bạn đã góp ý!
                                </h2>
                                <p className="mx-auto mb-5 max-w-[320px] text-[13.5px] leading-[1.6] text-moss">
                                    Tụi mình đã nhận được và sẽ phản hồi qua
                                    thông tin bạn để lại sớm nhất có thể.
                                </p>
                                <button
                                    onClick={close}
                                    className="h-11 rounded-control bg-grass px-6 text-[13.5px] font-bold text-white transition hover:bg-pine"
                                >
                                    Đóng
                                </button>
                            </div>
                            ...
                            <>
                                <div className="mb-4 flex items-start justify-between gap-3">
                                    <div>
                                        <h2 className="text-[18px] font-extrabold text-ink">
                                            Góp ý cho BỐP CAMPING
                                        </h2>
                                        <p className="mt-0.5 text-[12.5px] leading-[1.5] text-moss">
                                            Trải nghiệm chưa mượt chỗ nào, bạn
                                            cứ nói thẳng — tụi mình đọc hết đó!
                                        </p>
                                    </div>
                                    <button
                                        onClick={close}
                                ...
                                <form onSubmit={submit} className="space-y-3">
                                    ...
                                    <p className="text-[12px] text-moss">
                                        Cần ít nhất SĐT hoặc email để tụi mình
                                        phản hồi bạn nhé.
                                    </p>
                                    <div>
                                        <textarea
