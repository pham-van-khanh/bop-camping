...
/**
 * Dòng nhắc khung giờ giao/trả mặc định (adr_turnaround_buffer) — đọc từ shared prop `site`.
 * Chỉ hiển thị kỳ vọng cho khách, KHÔNG ảnh hưởng tồn kho. Ngoài khung giờ → khách liên hệ.
 */
