    ...
    return (
        <>
            ...
            <main className="mx-auto max-w-[1400px] px-5 pb-10 pt-[34px]">
                <div className="mb-6">
                    <div className="mb-[7px] font-mono text-[12px] tracking-[0.1em] text-campfire">
                        KHO THIẾT BỊ
                    </div>
                    <h1
                ...
                {service_locations.length > 1 && (
                    <div className="mb-4 flex flex-wrap items-center gap-2">
                        <span className="mr-0.5 text-[13px] font-semibold text-moss">
                            Thuê tại:
                        </span>
                        <button
                            onClick={() => applyFilters({ 'vi-tri': '' })}
                            className={chipBtn(viTri === '')}
                        >
                            Tất cả
                        </button>
                    ...
                    <span className="font-mono text-[13px] text-moss">
                        ...
                        {range_summary && (
                            <>
                                ...
                                ·{' '}
                                {products.length -
                                    range_summary.unavailable_count}{' '}
                                còn rảnh
                            </>
                        )}
                    </span>
                ...
                {isEmpty ? (
                    <div
                        className="rounded-[18px] border border-dashed px-6 py-[50px] text-center"
                        style={{
                            borderColor: '#cdd6b6',
                            background: '#FBFCF7',
                        }}
                    >
                        ...
                        <div className="mb-1.5 text-[18px] font-bold text-ink">
                            Chưa tìm thấy thiết bị phù hợp
                        </div>
                        <div className="mb-5 text-moss">
                            Thử từ khoá khác hoặc bỏ bớt bộ lọc.
                        </div>
                        <button
                            onClick={clearFilters}
                            className="h-[46px] rounded-control border border-[#cdd6b6] bg-white px-6 font-semibold text-pine"
                        >
                            Xoá bộ lọc
                        </button>
                    </div>
