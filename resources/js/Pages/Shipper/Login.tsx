                ...
                <div className="w-full max-w-[380px]">
                    <div className="mb-8 flex flex-col items-center gap-3">
                        ...
                        <div className="text-center">
                            <div className="text-[22px] font-extrabold text-pine">BopCamping Shipper</div>
                            <div className="mt-0.5 text-[13px] text-moss">Đăng nhập để xem lịch giao của bạn</div>
                        </div>
                    </div>
                    ...
                    <div className="rounded-[20px] border border-cardBorder bg-white p-7 shadow-sm">
                        <form onSubmit={submit} className="flex flex-col gap-4">
                            <div>
                                <label className="mb-1.5 block text-[13px] font-semibold text-pine">Số điện thoại</label>
                                <input
                                    type="tel"
                                    inputMode="tel"
                                    autoFocus
                            ...
                            <div>
                                <label className="mb-1.5 block text-[13px] font-semibold text-pine">Mật khẩu</label>
                                <input
                                    type="password"
                                ...
                                />
                                {errors.password && <p className="mt-1.5 text-[12px] text-red-500">{errors.password}</p>}
                            </div>
                            ...
                            <button
                                ...
                                style={{ background: ready ? '#557A2B' : '#c4cfae' }}
                            >
                    ...
                    <p className="mt-5 text-center text-[12px] text-[#9aab82]">
                        Tài khoản do chủ shop cấp · quên mật khẩu thì liên hệ chủ shop
                    </p>
                </div>
            </div>
        </>
