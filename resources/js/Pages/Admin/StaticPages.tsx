        ...
        <div className="p-6">
            ...
            <div className="mb-5">
                ...
                <p className="mt-1 text-[13px] text-moss">
                    Các trang tĩnh của website — sửa tiêu đề, ảnh bìa và nội
                    dung.
                </p>
            </div>
            ...
            <div className="overflow-hidden rounded-[14px] border border-cardBorder bg-white">
                {pages.map((p, i) => (
                    <div
                        key={p.id}
                        className={`flex flex-wrap items-center gap-3 px-4 py-3.5 ${i > 0 ? 'border-t border-[#f1f4ea]' : ''}`}
                    >
                        <div className="min-w-[180px] flex-1">
                            <div className="text-[14px] font-bold text-pine">
                                {p.title}
                            </div>
                            <div className="font-mono text-[11.5px] text-moss">
                                /{p.slug}
                            </div>
                        </div>
                        {p.updated_at && (
...
AdminStaticPages.layout = (page: ReactNode) => (
