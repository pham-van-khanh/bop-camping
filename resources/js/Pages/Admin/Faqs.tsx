                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-0.5 text-[13px] text-moss">
                            <span className="font-mono">{faqs.length}</span> câu
                            · hiển thị ở trang chủ theo thứ tự · tắt để ẩn tạm
                        </p>
                    </div>
                    <button
                        onClick={openCreate}
                    ...
                    {faqs.length === 0 ? (
                        ...
                        <table className="w-full text-[13px]">
                            <thead>
                                ...
                                >
                                    <th className="w-16 px-4 py-3 text-center font-semibold text-moss">
                                        Thứ tự
                                    </th>
                            ...
                            <tbody>
                                {faqs.map((faq) => (
                                    ...
                                    >
                                        <td className="px-4 py-3 text-center font-mono text-moss">
                                            {faq.sort_order}
                                        </td>
                                        <td className="px-4 py-3 font-semibold text-pine">
                                            {faq.question}
                                        </td>
                                        <td className="hidden max-w-[360px] truncate px-4 py-3 text-moss lg:table-cell">
                                            {faq.answer}
                                        </td>
                                        <td className="px-4 py-3 text-center">
                                            {faq.is_active ? (
                                                <span className="rounded-pill bg-[#dcebc4] px-2.5 py-1 text-[11px] font-bold text-[#3a5a1f]">
                                                    Đang hiện
                                                </span>
                                            ) : (
                                                <span className="rounded-pill bg-[#f1f4ea] px-2.5 py-1 text-[11px] font-bold text-moss">
                                                    Đang ẩn
                                                </span>
                                            )}
                                        </td>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full rounded-[10px] border border-cardBorder px-3.5 py-2.5 text-[13.5px] outline-none transition focus:border-grass"
                                    />
                                    <p className="mt-1 text-[11px] text-[#a3ad92]">
                                        Nhỏ = lên trước
                                    </p>
                                </div>
                                <div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
                    <div className="w-full max-w-sm rounded-[18px] bg-white p-6 shadow-xl">
                        ...
                        <p className="mb-4 text-[13px] text-moss">
                            Xoá câu hỏi này khỏi trang chủ? Hành động không thể
                            hoàn tác.
                        </p>
