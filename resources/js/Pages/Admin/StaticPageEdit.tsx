...
export default function AdminStaticPageEdit({
    ...
    const submit = (e: React.FormEvent) => {
        ...
        form.post(route('admin.pages.update', page.id), {
            forceFormData: true,
            preserveScroll: true,
        });
    };
                ...
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <div>
                        ...
                        {page.cover_url && (
                            <img
                                src={page.cover_url}
                                alt=""
                                className="mb-2 h-24 w-full max-w-[420px] rounded-[10px] border border-cardBorder object-cover"
                            />
                        )}
                        <input
                            type="file"
                    ...
                    <div>
                        <label className="mb-1.5 block text-[13px] font-semibold text-pine">
                            Nội dung
                            <span className="ml-1 font-normal text-moss">
                                (soạn tuần tự: đoạn văn, ảnh, đoạn văn… — phía
                                khách tự sắp bố cục ảnh/text xen kẽ)
                            </span>
                        </label>
                        <RichTextEditor
...
AdminStaticPageEdit.layout = (page: ReactNode) => (
