...
export default function AdminUsers({
    ...
    const [unassignTarget, setUnassignTarget] = useState<ShipperUser | null>(
        null,
    );
    ...
    const gotoPage = (p: number) =>
        router.get(
            route('admin.users'),
            { tab: 'customers', q: filters.q, page: p },
            { preserveScroll: true },
        );
    ...
    const submitAdmin = (e: React.FormEvent) => {
        ...
        if (modalMode === 'create') {
            ...
            form.put(route('admin.users.update', editingAdmin.id), {
    ...
    const confirmDemote = () => {
        ...
        router.patch(
            route('admin.users.role', demoteTarget.id),
            { is_admin: false },
            {
                preserveScroll: true,
                onSuccess: () => {
    ...
    return (
        <>
            ...
            <div className="p-6">
                ...
                <div className="mb-5">
                    ...
                    <p className="mt-0.5 text-[13px] text-moss">
                        <span className="font-mono">{stats.customers}</span>{' '}
                        khách hàng ·{' '}
                        <span className="font-mono">{stats.admins}</span> quản
                        trị viên
                    </p>
                </div>
                                            ...
                                            return (
                                                <Fragment key={c.id}>
                                                    ...
                                                    >
                                                        ...
                                                        <td className="px-4 py-3 text-center font-mono font-bold text-pine">
                                                            {c.orders_count}
                                                        </td>
                                                        <td className="px-4 py-3 text-right font-mono font-bold text-pine">
                                                            {money(
                                                                c.total_spent,
                                                            )}
                                                        </td>
                                                    ...
                                                    {expanded && (
                                                        <tr className="border-b border-[#f1f4ea]">
                                                            ...
                                                            >
                                                                ...
                                                                customerDetail?.id !==
                                                                    c.id ? (
                                                                    <div className="py-4 text-center text-[12.5px] text-moss">
                                                                        Đang tải
                                                                        lịch sử
                                                                        đơn…
                                                                    </div>
                                                                                        ...
                                                                                        (
                                                                                            ...
                                                                                            return (
                                                                                                ...
                                                                                                >
                                                                                                    ...
                                                                                                    <td className="px-3 py-2 font-mono text-pine">
                                                                                                        {
                                                                                                            o.start_date
                                                                                                        }{' '}
                                                                                                        →{' '}
                                        ...
                                        return (
                                            ...
                                            >
                                                <td className="px-4 py-3">
                                                    ...
                                                    {isSelf && (
                                                        <span className="ml-2 rounded-pill bg-[#dceaf6] px-2 py-0.5 text-[10.5px] font-bold text-[#2a6ea0]">
                                                            bạn
                                                        </span>
                                                    )}
                                                </td>
                                                <td className="px-4 py-3 font-mono text-moss">
                                                    {a.phone ?? '-'}
                                                </td>
                                                ...
                                                <td className="hidden px-4 py-3 font-mono text-moss sm:table-cell">
                                                    {a.created_at}
                                                </td>
                    ...
                    <>
                        <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
                            <p className="text-[12.5px] text-moss">
                                ...
                                và chỉ thấy đơn được gán cho mình.
                            </p>
                            <button
                                        ...
                                        {shippers.map((s) => (
                                            ...
                                            >
                                                <td className="px-4 py-3">
                                                    ...
                                                    {s.is_admin && (
                                                        <span className="ml-2 rounded-pill bg-[#eef5e0] px-2 py-0.5 text-[10.5px] font-bold text-grass">
                                                            cũng là admin
                                                        </span>
                                                    )}
                                                </td>
            ...
            {unassignTarget && (
                ...
                >
                    <div
                        className="w-full max-w-sm rounded-[18px] bg-white p-6 shadow-xl"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <h2 className="mb-2 text-[17px] font-extrabold text-pine">
                            Tắt vai shipper
                        </h2>
                        <p className="mb-3 text-[13.5px] text-moss">
                            ...
                            sẽ không đăng nhập được vào khu vực shipper nữa.
                        </p>
                        {unassignTarget.upcoming_legs > 0 && (
                            <p
                                className="mb-3 rounded-[10px] p-2.5 text-[12.5px]"
                                style={{
                                    background: '#f6ddd6',
                                    color: '#b3493a',
                                }}
                            >
                                Còn {unassignTarget.upcoming_legs} lượt giao/thu
                                sắp tới — các lượt đó sẽ về &quot;chưa
                                gán&quot;, cần gán lại người khác.
                            </p>
                        )}
                        {actionError && (
                            <p className="mb-3 text-[12.5px] text-[#b3493a]">
                                {actionError}
                            </p>
                        )}
                            ...
                            <div>
                                <label className="mb-1.5 block text-[13px] font-semibold text-pine">
                                    ...
                                    <span className="font-normal text-moss">
                                        (tuỳ chọn — nhận mail khi có đơn mới)
                                    </span>
                                </label>
                                <input
                                    type="email"
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
                    <div className="w-full max-w-sm rounded-[18px] bg-white p-6 shadow-xl">
                        ...
                        <p className="mb-4 text-[13px] text-moss">
                            ...
                            sẽ trở thành khách hàng thường, không còn vào được
                            trang quản trị.
                        </p>
                        {actionError && (
                        ...
                        <div className="flex justify-end gap-3">
                            ...
                            <button
                                ...
                                className="rounded-[10px] bg-grass px-5 py-2 text-[13px] font-bold text-white transition hover:bg-pine"
                            >
                                Hạ quyền
                            </button>
                        </div>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
                    <div className="w-full max-w-sm rounded-[18px] bg-white p-6 shadow-xl">
                        ...
                        <p className="mb-4 text-[13px] text-moss">
                            ...
                            ? Lịch sử đơn vẫn được giữ lại. Hành động không thể
                            hoàn tác.
                        </p>
                        {deleteTarget.warning && (
                            <p
                                className="mb-4 rounded-[10px] p-2.5 text-[12.5px]"
                                style={{
                                    background: '#f6ddd6',
                                    color: '#b3493a',
                                }}
