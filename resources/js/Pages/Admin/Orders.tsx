            ...
            <div className="p-6">
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="mt-0.5 text-[13px] text-moss">
                            Bấm vào đơn để mở màn hình chi tiết
                        </p>
                    </div>
                </div>
                ...
                <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
                    {[
                        ...
                        <div
                            key={s.label}
                            className="rounded-[14px] border border-cardBorder bg-white p-4"
                        >
                            <div
                    ...
                    <>
                        ...
                        <div className="mb-4 flex flex-wrap items-center gap-2">
                            ...
                            >
                                ...
                                <button
                                    type="submit"
                                    className="h-9 rounded-[10px] border border-cardBorder bg-white px-3 text-[12.5px] font-semibold text-pine hover:border-grass"
                                >
                                    Tìm
                                </button>
                                {filters.q && (
                                    <button
                                        ...
                                        className="h-9 rounded-[10px] px-2 text-[12.5px] text-[#8a967a] hover:text-[#b3493a]"
                                    >
                                        ✕
                                    </button>
                                )}
                                            ...
                                            return (
                                                ...
                                                >
                                                    <td className="px-4 py-3 font-mono font-bold text-pine">
                                                        {order.code}
                                                        {order.is_parent && (
                                                            <span className="ml-1.5 rounded-pill bg-grass px-2 py-0.5 text-[10px] font-bold text-white">
                                                                GỒM{' '}
                                                                {order.children
                                                                    ?.length ??
                                                                    0}{' '}
                                                    ...
                                                    <td className="px-4 py-3">
                                                        <div className="font-mono text-[12px] text-pine">
                                                            {order.start_date} →{' '}
                                                            {order.end_date}
                                                        </div>
                                                        {tag && (
                                                        ...
                                                        <div className="flex flex-wrap gap-1.5">
                                                            ...
                                                            {order.is_parent ? (
                                                                ...
                                                                <>
                                                                    ...
                                                                    {nexts.length ===
                                                                        0 && (
                                                                        <span className="text-[11px] text-[#b0ba98]">
                                                                            -
                                                                        </span>
                                                                    )}
                                                                </>
                        ...
                        <table className="w-full text-[13px]">
                            ...
                            <tbody>
                                {inventory.map((item) => (
                                    <tr
                                        key={item.id}
                                        className="border-b border-[#f1f4ea] hover:bg-[#fafcf7]"
                                    >
