...
export default function AdminSiteSettings() {
    ...
    const field = (
        ...
        <div>
            ...
            {errors[key] && (
                <p className="mt-1 text-[12px] text-[#b3493a]">{errors[key]}</p>
            )}
        </div>
    );
        ...
        <>
            ...
            <div className="mx-auto max-w-[820px] p-6">
                ...
                <p className="mb-5 text-[14px] text-moss">
                    Thông tin liên hệ &amp; mạng xã hội hiển thị ở footer và dải
                    Zalo trang chủ.
                </p>
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <section className="rounded-card border border-cardBorder bg-card p-5">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            {field(
                                ...
                                'Hotline chính',
                                '0976544370',
                                'Khách bấm vào sẽ gọi trực tiếp',
                            )}
                            {field(
                                'hotline_secondary',
                                'Hotline phụ',
                    ...
                    <section className="rounded-card border border-cardBorder bg-card p-5">
                        <h2 className="mb-1 text-[15px] font-bold text-pine">
                            Khung giờ giao/trả mặc định
                        </h2>
                        <p className="mb-3 text-[12.5px] text-moss">
                            Hiển thị kỳ vọng cho khách (VD: nhận từ 8h, trả
                            trước 20h). Ngoài khung giờ này khách liên hệ để sắp
                            xếp thêm. Không ảnh hưởng tính tồn kho.
                        </p>
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <label className="mb-1.5 block text-[13px] font-semibold text-pine">
                                ...
                                <input
                                    ...
                                    min="0"
                                    max="23"
                                    value={data.pickup_hour}
                                    onChange={(e) =>
                                        setData('pickup_hour', e.target.value)
                                    }
                                    className={inputCls}
                                />
                                {errors.pickup_hour && (
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    min="0"
                                    max="23"
                                    value={data.return_hour}
                                    onChange={(e) =>
                                        setData('return_hour', e.target.value)
                                    }
                                    className={inputCls}
                                />
                                {errors.return_hour && (
                            ...
                            <div>
                                <label className="mb-1.5 block text-[13px] font-semibold text-pine">
                                    Giờ kết thúc buổi sáng (0–23)
                                </label>
                                <input
                                    type="number"
                                    min="0"
                                    max="23"
                                    value={data.morning_end_hour}
                                    onChange={(e) =>
                                        setData(
                                            'morning_end_hour',
                                            e.target.value,
                                ...
                                <p className="mt-1 text-[11.5px] text-moss">
                                    Buổi sáng: giờ giao → giờ này (vd 8h–12h).
                                </p>
                                {errors.morning_end_hour && (
                                    <p className="mt-1 text-[12px] text-[#b3493a]">
                                        {errors.morning_end_hour}
                                    </p>
                                )}
                            ...
                            <div>
                                <label className="mb-1.5 block text-[13px] font-semibold text-pine">
                                    Giờ bắt đầu buổi chiều (0–23)
                                </label>
                                <input
                                    type="number"
                                    min="0"
                                    max="23"
                                    value={data.afternoon_start_hour}
                                    onChange={(e) =>
                                        setData(
                                ...
                                />
                                <p className="mt-1 text-[11.5px] text-moss">
                                    Buổi chiều: giờ này → giờ trả (vd 13h–21h).
                                    Khoảng giữa để chuẩn bị/ship.
                                </p>
                                {errors.afternoon_start_hour && (
                                    <p className="mt-1 text-[12px] text-[#b3493a]">
                                        {errors.afternoon_start_hour}
                                    </p>
                                )}
                    ...
                    <section className="rounded-card border border-cardBorder bg-card p-5">
                        ...
                        <p className="mb-3 text-[12.5px] text-moss">
                            Để trống thì icon tương ứng sẽ ẩn ở footer.
                        </p>
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            {field(
                                'facebook_url',
                    ...
                    <section className="rounded-card border border-cardBorder bg-card p-5">
                        ...
                        <p className="mb-3 text-[12.5px] text-moss">
                            Để trống thì không chèn mã nào. Lấy mã GA4 ở{' '}
                            <span className="font-semibold">
                                Google Analytics → Quản trị → Luồng dữ liệu
                            </span>
                            , mã xác minh ở{' '}
                            <span className="font-semibold">
                                Google Search Console
                            </span>{' '}
                            (phương thức thẻ HTML).
                        </p>
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            {field(
                                'ga_measurement_id',
                                'Mã đo lường GA4',
                                'G-XXXXXXXXXX',
                                'Dạng G-XXXXXXXX — bật Google Analytics 4',
                            )}
                            {field(
                                'google_site_verification',
                                'Mã xác minh Search Console',
                                'abcXyz123...',
                                'Chỉ dán phần content của thẻ meta verification',
                            )}
                        </div>
                    </section>
                    ...
                    <section className="rounded-card border border-cardBorder bg-[#f8faf4] p-5">
                        ...
                        <p className="mb-3 text-[12.5px] text-moss">
                            Địa chỉ ở footer lấy từ các vị trí đang mở trong mục{' '}
                            <span className="font-semibold">Điểm cắm trại</span>{' '}
                            — sửa ở đó.
                        </p>
                        <div className="flex flex-wrap gap-2">
                            {locations.length === 0 ? (
                                <span className="text-[13px] text-moss">
                                    Chưa có vị trí phục vụ nào đang mở.
                                </span>
                            ) : (
                                locations.map((l) => (
                                    <span
                                        key={l.name}
                                        className="rounded-pill border border-cardBorder bg-white px-3 py-1.5 text-[13px] font-semibold text-pine"
                                    >
                                        {l.name}
                                        {l.area ? ` – ${l.area}` : ''}
                                    </span>
...
AdminSiteSettings.layout = (page: ReactNode) => (
